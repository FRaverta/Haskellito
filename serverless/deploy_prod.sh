...
LAMBDA_BUDGET_LIMIT_USD="${LAMBDA_BUDGET_LIMIT_USD:-0}"
LAMBDA_BUDGET_SHUTDOWN_THRESHOLD_PERCENT="${LAMBDA_BUDGET_SHUTDOWN_THRESHOLD_PERCENT:-100}"
...
PARAMETER_OVERRIDES=(
  ...
  "LambdaBudgetLimitUsd=${LAMBDA_BUDGET_LIMIT_USD}"
  "LambdaBudgetShutdownThresholdPercent=${LAMBDA_BUDGET_SHUTDOWN_THRESHOLD_PERCENT}"
)
